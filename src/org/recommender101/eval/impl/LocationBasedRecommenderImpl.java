...
//It contains three files in tsv format, including 3112 users and 3298 venues with 27149 check-ins and 10377 tips.
    ...
    /**
     * Here we store the given n configuration (n/percentage of usersIDs)
     */
     ...
     */
    public LocationBasedRecommenderImpl(Properties configuration) throws Exception {
    ...
    public LocationBasedRecommenderImpl(String configurationFile) throws Exception {
     ...
     * and inits things
     */
    public LocationBasedRecommenderImpl() throws Exception {
    ...
    public void init() throws Exception {
        ...
        LocationDataLoader dataLoader = null;
        dataLoader = (LocationDataLoader) ClassInstantiator.instantiateClassByProperty(
    ...
    void addResultOfRound(List<EvaluationResult> resultsSoFar,
        ...
        if (existingResult == null) {
            throw new Exception(
                    "LocationBasedRecommender.averageResult: Cannot find Evalution Result for "
                            + aResult.getAlgorithm() + ":\n"
                            + aResult.getMethodName());
        }
    ...
    public void printSortedEvaluationResults(List<EvaluationResult> results) {
        ...
        List<AbstractMap.SimpleEntry<String, Map<String, Double>>> allResultsAlphabetical = new ArrayList<AbstractMap.SimpleEntry<String, Map<String, Double>>>();
        for (Map.Entry<String, Map<String, Double>> entry : allResults.entrySet()){
            AbstractMap.SimpleEntry<String, Map<String, Double>> newEntry = new AbstractMap.SimpleEntry<String, Map<String, Double>>(
            ...
            for(int i = 0; notAddedYet && i < allResultsAlphabetical.size(); i++){
                AbstractMap.SimpleEntry<String, Map<String, Double>> presentEntry = allResultsAlphabetical.get(i);
        ...
        for (AbstractMap.SimpleEntry<String, Map<String, Double>> entry : allResultsAlphabetical){
    ...
    public void readProperty(String fieldname, String fieldToStore) {
        try {
            ...
            Field f1 = LocationBasedRecommenderImpl.class.getDeclaredField(fieldname);
            String key = f1.get(this).toString();
            String propertyValue = properties.getProperty(key);
            if (propertyValue != null) {
                Debug.log("LocationBasedRecommenderImpl: readProperty : " + key + " = " + propertyValue);
            }
